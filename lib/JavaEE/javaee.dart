...
import 'package:pff_flutter_app/JavaEE/dbjavaee.dart';
...
class javaee extends StatefulWidget {
  const javaee({super.key});

  @override
  State<javaee> createState() => _javaeeState();
}

class _javaeeState extends State<javaee> {
